 ...
 * 
 * Branded email template for sending OTP codes for password reset
 * 
 ...
 * @param string $email User's email address (for display)
...
function getPasswordResetOTPTemplate($otp, $email = '')
{
    ...
    <head>
        ...
        <title>Password Reset Request - Mitsubishi Motors</title>
        <style>
            body {
                margin: 0;
                padding: 0;
        ...
        <div class="email-container">
            ...
            <div class="content">
                ...
                <p style="color: #555; font-size: 15px; line-height: 1.6;">
                    We received a request to reset the password for your Mitsubishi Motors account. 
                ...
                <div class="instructions">
                    ...
                    <p>1. Return to the password reset verification page</p>
                ...
                <div class="warning-box">
                    <p>⚠️ If you did NOT request this password reset, please ignore this email.</p>
                ...
                <p style="color: #666; font-size: 14px; line-height: 1.6;">
                    If you\'re having trouble with the password reset process, you can request a new code 
